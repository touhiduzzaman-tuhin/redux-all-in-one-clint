...
import { addPlayer, deletePlayer } from '../../redux/player/playerAction';
...
const Player = (props) => {
    console.log(props);
    const { players, addPlayer, deletePlayer} = props;
        ...
        <div className='container' align='center'>
            ...
            <div className='d-flex'>
                <div className='row player-details-area'>
                    {
                        players.map(player => <PlayerDetails key={player.id} player={player} addPlayer={addPlayer} deletePlayer={deletePlayer}></PlayerDetails>)
                    }
                </div>
